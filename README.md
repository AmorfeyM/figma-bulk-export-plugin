...
- 🔐 **Система авторизации** - контролируемый доступ через коды доступа
...
При первом запуске плагина требуется ввести код доступа для авторизации.

### Получение кода доступа:

- Код имеет формат: `CLIENT-XXXX-XXXX`
- Состоит из букв и цифр
- Регистр не важен при вводе
- Можно вводить вручную или вставить из буфера обмена

### Процесс авторизации:

1. При запуске плагина появится экран авторизации
2. Введите полученный код в поле ввода
3. Нажмите **"Подтвердить"** или **Enter**
4. При успешной авторизации откроется основной интерфейс
5. Авторизация сохраняется для последующих использований
